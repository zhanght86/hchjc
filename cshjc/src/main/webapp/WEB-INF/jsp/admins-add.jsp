    ...
    <form class="form form-horizontal" id="form-slide-add" method="post" enctype="multipart/form-data">
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-7">
                <img src="" alt="" style="display: none" class="headImage">
                <input type=file name=upfile class=upfile>
                <input type="text" value="" class="layerPlace" hidden="" name="headImg" id="headImg">
            </div>
            <div class="formControls col-xs-2 col-sm-2">
                <button type="button" class="btn-success btn" data-title="re" onclick="uploadImage(this)">上传</button>
            </div>
        </div>
        <div class="row cl">
    ...
    $(function () {
        ...
        $("#form-slide-add").validate({
            ...
            submitHandler: function (form) {
                ...
                $(form).ajaxSubmit({
                    url: "<%=basePathAdmin%>/admins.do?method=insert",
                    type: 'get',
                    dataType: 'json',
