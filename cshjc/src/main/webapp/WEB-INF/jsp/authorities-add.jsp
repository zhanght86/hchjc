                ...
                <dl class="permission-list">
                    ...
                    <dd>
                        <dl class="cl permission-list2">
                            <c:forEach items="${authorityList}" var="authority" varStatus="index">
                                <dt style="width: 30%;margin-top: 1em">
                                    <label class="">
                                        <input type="checkbox" value="${authority.toString()}" name="items">
                                        ${authority.toString()}</label>
                                </dt>
    ...
    $(function () {
        ...
        $("#form-admin-add").validate({
            ...
            submitHandler: function (form) {
                $(form).ajaxSubmit({
                    url: "<%=basePathAdmin%>/authorities.do?method=insert",
                    type: 'get',
                    dataType: 'json',
